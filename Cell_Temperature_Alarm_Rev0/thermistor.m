...
%% Global Parameters
t = 0:0.1:180;             % Time up to 3 minutes in increments of 100 ms
vsense = zeros(size(t));   % Initialize voltage at the thermistor divider node
tmin = 10;                 % Minimum temperature in degrees C
...
therm.r = zeros(size(t)); % Initialize thermistor resistance array
